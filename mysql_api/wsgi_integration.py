# 
# MySQL API Integration for PythonAnywhere WSGI
# Integrates MySQL API routes directly into the main Flask application
# Use this code directly in your WSGI file instead of exec()
#

def integrate_mysql_api(flask_app):
    """
    Integrate MySQL API routes into existing Flask application
    Call this function from your WSGI file after importing your main app
    """
    import sys
    import os
    import json
    ...
    # Add mysql_api to path if not already there
    ...
    try:
        ...
        @flask_app.route('/mysql-api/info', methods=['GET'])
        def mysql_api_info():
        ...
        @flask_app.route('/mysql-api/entities', methods=['GET'])
        ...
        @flask_app.route('/mysql-api/entities', methods=['POST'])
        ...
        @flask_app.route('/mysql-api/import/concierge-v2', methods=['POST'])
        ...
        print("✅ MySQL API routes integrated successfully")
        return True
...
# Example usage in WSGI file:
"""
# Your existing WSGI setup
from concierge_parser import app as application

# Add MySQL API integration
from mysql_api.wsgi_integration import integrate_mysql_api
integrate_mysql_api(application)
"""